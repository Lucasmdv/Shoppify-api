...
public record StoreRequest(
                ...
                @NotBlank(message = "Store name is required") @Size(max = 15, message = "Store name must be less than 15 characters") String storeName,
                ...
                @Size(max = 20, message = "Postal code must be less than 20 characters") String postalCode,

                @Schema(description = "Facebook page URL", example = "https://facebook.com/shoppify")
                @Size(max = 255, message = "Facebook URL must be less than 255 characters") String facebook,

                @Schema(description = "Instagram profile URL", example = "https://instagram.com/shoppify")  
                @Size(max = 255, message = "Instagram URL must be less than 255 characters") String instagram,

                @Schema(description = "X (Twitter) profile URL", example = "https://x.com/shoppify")
                @Size(max = 255, message = "X/Twitter URL must be less than 255 characters") String twitter,
